...
> 문서 목차: **`Docs/README.md`** — 스토리 `Story_FollowMe.md` · 대사·DM `Content.md` · 우선순위 `Production.md` · 맵 `KDS/README.md`
...
1. **역할형 에이전트(작가·레벨·프로듀서 채팅 분리) 사용 안 함** — 한 채팅에 작업 지시. `AgentBoard.md`도 쓰지 않음.
2. **@ 참조를 좁게** — `@Codebase`보다 `@파일`·`@폴더`.
3. **긴 문서 붙여넣기 금지** — `Docs/README.md`에서 필요한 파일만 참조.
4. **에러는 로그 원문 줄만** 붙여넣기.
5. 맵 작업 시 `Assets/00.Work/KDS/AGENTS.md` 준수. KSY/YHW 폴더 수정 금지.
