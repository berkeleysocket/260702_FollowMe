...
namespace FollowMe.KDS
{
    ...
    public static class StageMapDatabase
    {
        public static readonly StageMapSpec[] All =
        {
            ...
            // Act2: Act1(최대 150)보다 확실히 긴 카페 거리 + 플랫폼 밀집
            Spec(4,  "달콤함", StageTemplate.CafeAlley,  205, 3, 3, 2, 0, false, 28, 58, 90, 125, 175),
            Spec(5,  "달콤함", StageTemplate.CafeAlley,  215, 3, 2, 2, 1, false, 28, 60, 95, 132, 185),
            Spec(6,  "달콤함", StageTemplate.CafeAlley,  225, 3, 2, 2, 1, false, 30, 64, 100, 140, 195),
            Spec(7,  "달콤함", StageTemplate.CafeAlley,  235, 4, 2, 2, 2, false, 30, 66, 105, 148, 205),
            Spec(8,  "달콤함", StageTemplate.CafeAlley,  250, 4, 2, 2, 2, false, 32, 70, 112, 158, 218),
            Spec(9,  "불꽃",   StageTemplate.Fireworks,  260, 3, 3, 2, 1, false, 32, 70, 120, 170, 225),
            Spec(10, "불꽃",   StageTemplate.Fireworks,  275, 3, 2, 2, 2, false, 32, 72, 128, 180, 238),
            Spec(11, "불꽃",   StageTemplate.Fireworks,  290, 4, 2, 2, 2, false, 34, 76, 138, 192, 250),
